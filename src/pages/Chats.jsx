...
import { Send, Search, Ban, AlertCircle, CheckCircle } from 'lucide-react'
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (error) => {
        ...
        // Even on error, stop loading and show empty state
        setChats([])
        setLoading(false)
      }
    )
            ...
            <div className="flex-1 overflow-y-auto">
              {filteredChats.length === 0 ? (
                <div className="p-8 text-center text-gray-500">
                  ...
                  <p className="text-xs mt-1">Users will appear here when they contact support</p>
                </div>
              ) : (
